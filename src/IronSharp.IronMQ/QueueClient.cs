...
namespace IronSharp.IronMQ
{
    ...
    public class QueueClient
    {
        ...
        /// </remarks>
        public IIronTask<MessageCollection> Get(int? n = null, TimeSpan? timeout = null)
        {
            int? seconds = null;
            if (timeout.HasValue)
            {
        ...
        public IIronTask<MessageCollection> Get(int? n = null, int? timeout = null, int? wait = null)
        {
            ...
            var builder = new IronTaskRequestBuilder(_client.EndpointConfig)
            {
                ...
                HttpContent = new JsonContent(payload)
            };

            if (wait.HasValue)
            {
                builder.Query.Add("wait", Convert.ToString(wait));
            }
        ...
        ///     https://github.com/iron-io/iron_mq_ruby#get-messages-from-a-queue
        /// </remarks>
        public IIronTask<MessageCollection> Get(int? n = null, int? timeout = null)
        {
